  ...
  return (
    ...
    <div className='flex justify-center items-center h-full  ]'>
      <div className='w-[100%] h-full bg-primary-color flex text-white rounded-[12px]  py-[10px]'>
        ...
        <div className='text-[16px] md:text-[32px] font-bold'>{oneYearMortality.toFixed(1)}%</div>
        
        <span className='text-[12px] md:text-[22px] font-bold'>1-year mortality</span>
        </div>
        </div>
        <div className='w-full h-full   border-l-[1px] flex justify-center items-center'>
        <div className='flex flex-col'>
      <div className='text-[16px] md:text-[32px]  font-bold'>{threeYearMortality.toFixed(1)}%</div>
      <span className='text-[12px] md:text-[22px] font-bold'>3-year mortality</span>
      </div>  
        </div>
      </div>
    </div>
